...
public sealed class UnhideJobForUserCommandHandler(JobSearchDbContext dbContext) : IRequestHandler<UnhideJobForUserCommand, UserJobStateResponse?>
{
    public async Task<UserJobStateResponse?> Handle(UnhideJobForUserCommand request, CancellationToken cancellationToken)
    {
