...
public sealed class SaveJobCommandHandler(JobSearchDbContext dbContext) : IRequestHandler<SaveJobCommand, UserJobStateResponse?>
{
    public async Task<UserJobStateResponse?> Handle(SaveJobCommand request, CancellationToken cancellationToken)
    {
